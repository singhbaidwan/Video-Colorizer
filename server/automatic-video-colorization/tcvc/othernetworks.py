...
# load_arch = run_path("/content/MIRNetv2/basicsr/models/archs/mirnet_v2_arch.py")
# parameters = {
#     'inp_channels':3,
#     'out_channels':3, 
#     'n_feat':80,
...
# weights = "/content/MIRNetv2/Super_Resolution/pretrained_models/sr_x4.pth"
...
class InpaintGenerator(BaseNetwork):
    def __init__(self, model,residual_blocks=8, init_weights=True):
